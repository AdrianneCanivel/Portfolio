...
public class MyWorksGraphicDesign12 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign12() {
		...
		// lblBack go to MyWorksGraphicDesign11
		...
		lblBack.setBounds(792, 462, 34, 27);
		contentPane.add(lblBack);
		
		// lblNext go to MyWorksGraphicDesign13
		...
		lblNext.setBounds(836, 462, 34, 27);
		contentPane.add(lblNext);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign12.class.getResource("/newnew/12GD.png")));
