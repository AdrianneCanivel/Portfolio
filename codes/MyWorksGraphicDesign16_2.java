...
public class MyWorksGraphicDesign16_2 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign16_2() {
		...
		// Click lbl1 to MyWorksGraphicDesign16_1
		...
		lbl1.setBounds(434, 428, 19, 27);
		contentPane.add(lbl1);
		
		// Click lbl2 to MyWorksGraphicDesign16_2
		JLabel lbl2 = new JLabel("");
		lbl2.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign16_2 GD16_2 = new MyWorksGraphicDesign16_2();
				GD16_2.setVisible(true);
	            dispose();
			}
		});
		lbl2.setBounds(459, 428, 19, 27);
		contentPane.add(lbl2);
		
		// Click backToMainGD to go back to MyGraphicDesign16
		...
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign16_2.class.getResource("/newnew/16_2GD.png")));
