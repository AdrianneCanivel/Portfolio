...
public class MyWorksGraphicDesign1_3 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign1_3() {
		...
		lblBackToMyWorks.setBounds(36, 22, 104, 27);
		...
		backToMainGD.setBounds(837, 464, 46, 21);
		contentPane.add(backToMainGD);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign1_3 = new JLabel("");
		imgGraphicDesign1_3.setIcon(new ImageIcon(MyWorksGraphicDesign1_3.class.getResource("/newimgs/01_3GraphicDesign.png")));
		imgGraphicDesign1_3.setBounds(0, 0, 912, 513);
		contentPane.add(imgGraphicDesign1_3);
	}
