...
public class MyWorksGraphicDesign9 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign9() {
		...
		// lblBack go to MyWorksGraphicDesign8
		...
		// lblNext go to MyWorksGraphicDesign10
		...
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign9.class.getResource("/newnew/09GD.png")));
