...
public class MyWorksGraphicDesign6 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign6() {
		...
		// lblBack go to MyWorksGraphicDesign5
		...
		lblBack.setBounds(797, 459, 34, 27);
		contentPane.add(lblBack);
		
		// lblNext go to MyWorksGraphicDesign7
		...
		lblNext.setBounds(841, 459, 34, 27);
		contentPane.add(lblNext);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign6.class.getResource("/newnew/06GD.png")));
