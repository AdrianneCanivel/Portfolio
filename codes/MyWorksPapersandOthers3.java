...
public class MyWorksPapersandOthers3 extends Start {

	private JPanel contentPane;

	public MyWorksPapersandOthers3() {
		...
		GoToLink1.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				try {
					Desktop.getDesktop().browse(new URL("https://drive.google.com/file/d/1CqAIq4a1how482ZZ7UTiB1QCDuYRT2lG/view?usp=share_link").toURI());
				}
				catch(Exception E1) {
		...
		GoToLink1.setBounds(485, 248, 306, 73);
		...
		GoToLink2.setBounds(125, 162, 312, 275);
		contentPane.add(GoToLink2);
		
		// lblBack go to MyWorksPapersandOthers2
		...
		lblBack.setBounds(482, 332, 34, 19);
		...
		lblNext.setBounds(526, 332, 34, 19);
		contentPane.add(lblNext);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksPapersandOthers3.class.getResource("/Imgs/P&O3.png")));
