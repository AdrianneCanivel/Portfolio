...
public class MyWorksGraphicDesign11 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign11() {
		...
		// lblBack go to MyWorksGraphicDesign10
		JLabel lblBack = new JLabel("");
		lblBack.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign10 GD10 = new MyWorksGraphicDesign10();
				GD10.setVisible(true);
			    dispose();
			}
		});
		...
		// lblNext go to MyWorksGraphicDesign12
		...
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign11.class.getResource("/newnew/11GD.png")));
