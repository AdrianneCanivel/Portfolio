...
public class MyWorksGraphicDesign14_1 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign14_1() {
		...
		// Click lbl1 to MyWorksGraphicDesign14_1
		...
		lbl1.setBounds(420, 427, 19, 27);
		contentPane.add(lbl1);

		// Click lbl2 to MyWorksGraphicDesign14_2
		JLabel lbl2 = new JLabel("");
		lbl2.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign14_2 GD14_2 = new MyWorksGraphicDesign14_2();
				GD14_2.setVisible(true);
	            dispose();
			}
		});
		lbl2.setBounds(445, 427, 19, 27);
		contentPane.add(lbl2);
		
		// Click lbl3 to MyWorksGraphicDesign14_3
		JLabel lbl3 = new JLabel("");
		lbl3.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign14_3 GD14_3 = new MyWorksGraphicDesign14_3();
				GD14_3.setVisible(true);
	            dispose();
			}
		});
		lbl3.setBounds(473, 427, 19, 27);
		contentPane.add(lbl3);
		
		// Click backToMainGD to go back to MyGraphicDesign14
		...
		backToMainGD.setBounds(829, 464, 47, 27);
		contentPane.add(backToMainGD);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign14_1.class.getResource("/newnew/14_1GD.png")));
