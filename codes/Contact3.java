...
public class Contact3 extends Start {
	...
	public Contact3() {
		...
		lblFB.setBounds(561, 280, 185, 35);
		...
		lblIG.setBounds(561, 326, 202, 35);
		...
		lblTwt.setBounds(561, 365, 202, 35);
		contentPane.add(lblTwt);
		
		// Logout Button, will redirect to Logout Frame if clicked
		...
		lbllogout.setBounds(10, 461, 70, 41);
		contentPane.add(lbllogout);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(Contact3.class.getResource("/ab/Logout (1).png")));
