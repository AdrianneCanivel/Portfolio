...
public class MyWorksGraphicDesign1_1 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign1_1() {
		...
		lblBackToMyWorks.setBounds(34, 22, 114, 27);
		...
		backToMainGD.setBounds(837, 464, 50, 27);
		contentPane.add(backToMainGD);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign1_1 = new JLabel("");
		imgGraphicDesign1_1.setIcon(new ImageIcon(MyWorksGraphicDesign1_1.class.getResource("/newimgs/01_1GraphicDesign.png")));
		imgGraphicDesign1_1.setBounds(0, 0, 912, 513);
		contentPane.add(imgGraphicDesign1_1);
	}
