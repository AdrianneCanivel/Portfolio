...
public class MyWorksGraphicDesign13_3 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign13_3() {
		...
		// Click lbl1 to MyWorksGraphicDesign13_1
		...
		lbl1.setBounds(418, 426, 19, 27);
		contentPane.add(lbl1);
		
		// Click lbl2 to MyWorksGraphicDesign13_2
		JLabel lbl2 = new JLabel("");
		lbl2.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign13_2 GD13_2 = new MyWorksGraphicDesign13_2();
				GD13_2.setVisible(true);
	            dispose();
			}
		});
		lbl2.setBounds(447, 426, 19, 27);
		contentPane.add(lbl2);
		
		// Click lbl3 to MyWorksGraphicDesign13_3
		JLabel lbl3 = new JLabel("");
		lbl3.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign13_3 GD13_3 = new MyWorksGraphicDesign13_3();
				GD13_3.setVisible(true);
	            dispose();
			}
		});
		lbl3.setBounds(471, 426, 19, 27);
		contentPane.add(lbl3);
		
		// Click backToMainGD to go back to MyGraphicDesign13
		...
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign13_3.class.getResource("/newnew/13_3GD.png")));
