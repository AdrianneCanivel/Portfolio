...
public class MyWorksGraphicDesign19 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign19() {
		...
		// lblBack go to MyWorksGraphicDesign18
		...
		lblBack.setBounds(794, 461, 34, 27);
		contentPane.add(lblBack);
		
		// lblNext go to MyWorksGraphicDesign20
		...
		lblNext.setBounds(838, 461, 34, 27);
		contentPane.add(lblNext);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign19.class.getResource("/newnew/19GD.png")));
