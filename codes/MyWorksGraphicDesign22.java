...
public class MyWorksGraphicDesign22 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign22() {
		...
		// lblBack go to MyWorksGraphicDesign21
		...
		lblBack.setBounds(792, 464, 34, 27);
		contentPane.add(lblBack);
		
		// lblNext go to MyWorksGraphicDesign23
		...
		lblNext.setBounds(836, 464, 34, 27);
		contentPane.add(lblNext);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign22.class.getResource("/newnew/22GD.png")));
