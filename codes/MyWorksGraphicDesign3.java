...
public class MyWorksGraphicDesign3 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign3() {
		...
		// lblViewGD will go to MyWorksGraphicDesign3_1
		...
		lblViewGD.setBounds(89, 145, 542, 307);
		contentPane.add(lblViewGD);
		
		// lblBack go to MyWorksGraphicDesign2
		...
		lblBack.setBounds(796, 461, 34, 27);
		contentPane.add(lblBack);
		
		// lblNext go to MyWorksGraphicDesign4
		...
		lblNext.setBounds(840, 461, 34, 27);
		contentPane.add(lblNext);
				
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign3.class.getResource("/newimgs/03GraphicDesign.png")));
