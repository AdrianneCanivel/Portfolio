...
public class MyWorksGraphicDesign8 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign8() {
		...
		// lblViewGD will go to MyWorksGraphicDesign8_1
		...
		lblViewGD.setBounds(225, 130, 219, 334);
		contentPane.add(lblViewGD);
		
		// lblBack go to MyWorksGraphicDesign7
		JLabel lblBack = new JLabel("");
		lblBack.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign7 GD7 = new MyWorksGraphicDesign7();
				GD7.setVisible(true);
	            dispose();
			}
		});
		lblBack.setBounds(797, 463, 34, 27);
		contentPane.add(lblBack);
		
		// lblNext go to MyWorksGraphicDesign9
		JLabel lblNext = new JLabel("");
		lblNext.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign9 GD9 = new MyWorksGraphicDesign9();
				GD9.setVisible(true);
	            dispose();
			}
		});
		lblNext.setBounds(841, 463, 34, 27);
		contentPane.add(lblNext);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign8.class.getResource("/newnew/08GD.png")));
