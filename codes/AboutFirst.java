...
public class AboutFirst extends Start {
	...
	public AboutFirst() {
		...
		JLabel imgAboutFirst = new JLabel("");
		imgAboutFirst.setIcon(new ImageIcon(AboutFirst.class.getResource("/ab/1AB.png")));
		imgAboutFirst.setBounds(0, 0, 912, 513);
		contentPane.add(imgAboutFirst);
	}
