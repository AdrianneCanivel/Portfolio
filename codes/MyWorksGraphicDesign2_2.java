...
public class MyWorksGraphicDesign2_2 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign2_2() {
		...
		// Click lbl1 to MyWorksGraphicDesign2_1
		...
		lbl1.setBounds(428, 411, 19, 27);
		contentPane.add(lbl1);
		
		// Click lbl2 to MyWorksGraphicDesign2_2
		JLabel lbl2 = new JLabel("");
		lbl2.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign2_2 GD2_2 = new MyWorksGraphicDesign2_2();
				GD2_2.setVisible(true);
	            dispose();
			}
		});
		lbl2.setBounds(460, 411, 19, 27);
		contentPane.add(lbl2);
		
		// Click backToMainGD to go back to MyGraphicDesign2
		...
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign2_2.class.getResource("/newimgs/02_2GraphicDesign.png")));
