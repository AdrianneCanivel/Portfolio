...
public class MyWorksGraphicDesign10 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign10() {
		...
		// lblBack go to MyWorksGraphicDesign9
		...
		lblBack.setBounds(795, 463, 34, 27);
		contentPane.add(lblBack);
		
		// lblNext go to MyWorksGraphicDesign11
		JLabel lblNext = new JLabel("");
		lblNext.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign11 GD11 = new MyWorksGraphicDesign11();
				GD11.setVisible(true);
	            dispose();
			}
		});
		lblNext.setBounds(839, 463, 34, 27);
		contentPane.add(lblNext);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign2 = new JLabel("");
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign10.class.getResource("/newnew/10GD.png")));
