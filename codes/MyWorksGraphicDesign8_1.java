...
public class MyWorksGraphicDesign8_1 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign8_1() {
		...
		imgGraphicDesign2.setIcon(new ImageIcon(MyWorksGraphicDesign8_1.class.getResource("/newnew/08_1GD.png")));
