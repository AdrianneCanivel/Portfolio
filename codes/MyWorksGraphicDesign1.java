...
public class MyWorksGraphicDesign1 extends Start {

	private JPanel contentPane;

	public MyWorksGraphicDesign1() {
		...
		lblBackToMyWorks.setBounds(31, 23, 115, 27);
		...
		// lblViewGD will go to MyWorksGraphicDesign1_1
		...
		lblViewGD.setBounds(102, 139, 518, 313);
		contentPane.add(lblViewGD);
		
		// lblNext go to MyWorksGraphicDesign2
		JLabel lblNext = new JLabel("");
		lblNext.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				MyWorksGraphicDesign2 GD2 = new MyWorksGraphicDesign2();
				GD2.setVisible(true);
	            dispose();
			}
		});
		lblNext.setBounds(841, 461, 34, 27);
		contentPane.add(lblNext);
		
		// Sets the background picture of the whole frame
		JLabel imgGraphicDesign1 = new JLabel("");
		imgGraphicDesign1.setIcon(new ImageIcon(MyWorksGraphicDesign1.class.getResource("/newimgs/01GraphicDesign.png")));
		imgGraphicDesign1.setBounds(0, 0, 912, 513);
		contentPane.add(imgGraphicDesign1);
	}
